    ...
    <div className="text-lg flex -z-20 min-h-screen w-full">
      <section className="w-[15%] sm:w-20 lg:w-[25%] xl:w-[20%] xl:min-w-[250px] h-dvh fixed flex flex-col justify-between border-r-[1px] border-gray-600 z-10 transition-all duration-300">
        <div className="w-full flex flex-col items-center lg:items-stretch lg:pl-6 xl:pl-10 lg:pr-4 xl:pr-8 mt-4">
          <Link to="/" className="w-full flex justify-center lg:justify-start mb-6 lg:mb-10">
            <img src={logo} alt="Echoes" className="h-8 sm:h-10 lg:h-14 xl:h-16" />
          </Link>
          ...
          >
            <House size={28} className="shrink-0 lg:mr-3" /> <span className="hidden lg:inline">Home</span>
          </Link>
          <button
          ...
          >
            <Search size={28} className="shrink-0 lg:mr-3" /> <span className="hidden lg:inline">Search</span>
          </button>
          <Link
            to="/explore"
          ...
          >
            <Compass size={28} className="shrink-0 lg:mr-3" /> <span className="hidden lg:inline">Explore</span>
          </Link>
          <a className="flex m-2 lg:ml-2 xl:ml-4 p-2 items-center justify-center lg:justify-start hover:bg-white/5 rounded-xl transition duration-200 cursor-pointer">
            <Bell size={28} className="shrink-0 lg:mr-3" /> <span className="hidden lg:inline">Pings</span>
          </a>
          <a className="flex m-2 lg:ml-2 xl:ml-4 p-2 items-center justify-center lg:justify-start hover:bg-white/5 rounded-xl transition duration-200 cursor-pointer">
            <Mail size={28} className="shrink-0 lg:mr-3" /> <span className="hidden lg:inline">Whispers</span>
          </a>
          <Link
            to="/archive"
          ...
          >
            <Bookmark size={28} className="shrink-0 lg:mr-3" /> <span className="hidden lg:inline">Archive</span>
          </Link>
          <Link
            to="/settings"
          ...
          >
            <Bolt size={28} className="shrink-0 lg:mr-3" /> <span className="hidden lg:inline">Settings</span>
          </Link>
          ...
          <div className="w-full flex justify-center lg:justify-start lg:ml-2 xl:ml-4 mt-2 mb-4">
            ...
            >
              <AudioLines size={28} className="shrink-0 lg:mr-3" /> <span className="hidden lg:inline">Echo</span>
            </button>
          </div>
