    ...
    <div className="bg-[#111628]  text-white text-lg flex">
      <section className="w-[20%] h-dvh fixed pr-8 flex flex-col justify-between pl-10 border-r-[1px] border-gray-600">
        <div>
          ...
          <Link to="/create" className="flex m-2 ml-4 p-2 items-center hover:bg-white/90 rounded-xl transition duration-200 bg-gradient-to-r from-green-400 to-indigo-600 text-white mt-4 font-semibold">
